...
public class DealContractorControllerImpl implements DealContractorController {

    private final static Logger LOGGER = LoggerFactory.getLogger(DealContractorControllerImpl.class);
